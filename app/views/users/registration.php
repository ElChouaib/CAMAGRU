	...
	<div class="row justify-content-center">
		<div class="card">
			<header class="card-header">
				<a href="<?php echo URLROOT;?>/users/login" class="float-right btn btn-outline-danger mt-1">Login</a>
			...
			<article class="card-body">
					...
					<form  action="<?php echo URLROOT;?>/users/registration" method="post">
						...
						<input type="submit" name="submit" value="registration" class="btn btn-lg btn-danger btn-block">
					</form>
			</article>		
		</div>
