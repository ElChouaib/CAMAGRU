		...
		<div class="col-md-6">
			<div class="card">
				<header class="card-header">
					...
					<a href="<?php echo URLROOT;?>/users/registration" class="float-right btn btn-outline-danger mt-1">Register</a>
				...
				<article class="card-body">
        			...
        			<button type="submit" name="forgot_password" class="btn btn-info btn-block"> <a href="<?php echo URLROOT;?>/users/forgot_password"> Recover Your Account </a> </button>
				</article>		
			</div>
		</div>
	</div>
