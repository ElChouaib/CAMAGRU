...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header bg-danger text-white btn">
                    <strong>Profile
                    </strong>
                </div>
                <div class="card-body" >
                ...
                <form action="<?php echo URLROOT ;?>/users/edit" method="post">
                    ...
                    <div class="row justify-content-center">
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" name="notif" id="notif" value="<?php echo $_SESSION['notif']; ?>">
                            <i class="fas fa-bell"></i>
                            <label class="form-check-label" for="materialChecked2">Notifications</label>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                            <button type="submit"  href="<?php echo URLROOT ;?>/users/edit" name="edit" value="edit" class="btn btn-block btn-danger"> Edit </button>
                    </div>
